...
VALUES ('admin@thoughtfirst.in', '$2b$12$NrCPmE/ulmyRTXCnIF9wfeT/YdLt9JCg9wMmo/sUFloPp6vUlp.5a', 'super_admin');

-- ======================
-- SCHEMA UPGRADES (2026-03-30)
-- ======================
...
CREATE TABLE IF NOT EXISTS `temple_registry` (
  ...
  `trust_name` VARCHAR(255) DEFAULT '',
  `shrine_type` VARCHAR(100) DEFAULT '',
  `darshan_types` JSON DEFAULT NULL,
  ...
  `sms_template_telugu` TEXT DEFAULT NULL,
  `sms_template_hindi` TEXT DEFAULT NULL,
  `sms_template_english` TEXT DEFAULT NULL,
  `contact_phone` VARCHAR(20) DEFAULT '',
